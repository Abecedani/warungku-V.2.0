...
@section('title', 'Checkout - WarungKu')
            ...
            <div class="bg-white rounded-3 shadow-sm p-4 mb-4">
                ...
                @foreach($carts as $item)
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        <div>
                            <p class="mb-0 small fw-bold">{{ $item->menu->name }}</p>
                            <small class="text-muted">{{ $item->quantity }}x @ Rp {{ number_format($item->menu->price, 0, ',', '.') }}</small>
                        </div>
